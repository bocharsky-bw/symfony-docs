...
.. configuration-block::
    ...
    .. code-block:: php-annotations
        ...
        class MainController extends Controller
        {
             ...
             */
            public function projectHomepageAction()
            {
                // ...
            }
    ...
    .. code-block:: yaml
        ...
        projects_homepage:
            ...
            defaults: { _controller: AcmeDemoBundle:Main:projectHomepage }
    ...
    .. code-block:: xml
        ...
        <routes xmlns="http://symfony.com/schema/routing"
            ...
            <route id="projects_homepage" path="/" host="{project_name}.example.com">
                <default key="_controller">AcmeDemoBundle:Main:projectHomepage</default>
            </route>
    ...
    .. code-block:: php
        ...
        $collection->add('project_homepage', new Route('/', array(
            '_controller' => 'AcmeDemoBundle:Main:projectHomepage',
